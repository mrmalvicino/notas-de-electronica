...
\begin{mdframed}[style=MyFrame2]
    ...
    \begin{equation*}
        \Delta \V = \cstcoulomb \bb{\frac{q_1}{\sqrt{R^2 + y_0^2}} + \frac{q_2}{\sqrt{R^2 + y_0^2}}} = 0
    \end{equation*}

    En el punto $\vec{x}_2$ el potencial es:
    \begin{equation*}
        \Delta \V = \cstcoulomb \bb{\frac{q_1}{x_0 + R} + \frac{q_2}{x_0 - R}}
    \end{equation*}
\end{mdframed}
...
\begin{mdframed}[style=MyFrame2]
    ...
    Luego:
    \begin{equation*}
        \Delta \V = \cstcoulomb \, \lambda \int_D^{D+L} \frac{1}{\sqrt{x^2+H^2}} \, \dif x
    \end{equation*}
\end{mdframed}
...
\begin{mdframed}[style=MyFrame2]
    ...
    Luego:
    \begin{equation*}
        \Delta \V = \frac{\cstcoulomb}{\sqrt{D^2 + R_0^2}} \int \dif q = \frac{\cstcoulomb \, Q}{\sqrt{D^2 + R_0^2}}
    \end{equation*}
\end{mdframed}
...
\begin{mdframed}[style=MyFrame2]
    ...
    Luego:
    \begin{align*}
        \Delta \V &= \cstcoulomb \, \sigma \, \int_0^{2\pi} \dif \phi \int_0^{R_0} \frac{R}{\sqrt{D^2+R^2}} \, \dif R
        \\[1ex]
