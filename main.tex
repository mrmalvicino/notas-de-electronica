...
\begin{mdframed}[style=MyFrame2]
    \begin{example}
        \label{eg:elec-placa}
    \end{example}
    \cusTi{Campo eléctrico en placa infinita}
    \begin{formatI}
...
\begin{mdframed}[style=MyFrame2]
    ...
    \begin{equation*}
        \left\{
        \begin{aligned}
            E &= \frac{Q \, r}{4 \, \pi \, \epsilon_0 \, R^3} \quad r<R
            \\[1ex]
            E &= \frac{Q}{4 \, \pi \, \epsilon_0 \, r^2} \quad r>R
        \end{aligned}
        \right.
    \end{equation*}
    \begin{center}
...
Es decir, un conductor por el que no pasa corriente.
