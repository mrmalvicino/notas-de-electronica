...
\begin{equation*}
    \frac{\dif}{\dif t} \current_C(t) = - \frac{\current_C(t)}{\tau}
\end{equation*}

Cuya solución es
\begin{equation*}
    \current_C(t) = I_0 \, e^{-\tfrac{t}{\tau}}
\end{equation*}
...
\begin{equation*}
    \voltage_L(t) = L \, \frac{\dif}{\dif t} \current(t)
\end{equation*}
...
\begin{gather*}
    V_C = \frac{V_S}{2 \, \pi \, f \, C \sqrt{R^2 + \bb{\dfrac{1}{2 \, \pi \, f \, C}}^2}}
    \\[1ex]
    \phi_{\voltage_C} = - \arctan{\bb{\dfrac{-1}{2 \, \pi \, f \, C \, R}}} - \ang{90}
\end{gather*}
